...
class Optimizer(ABC):
    ...
    def build_update_fn(self, **compile_kwargs) -> Function:
        ...
        fn = function([x, y, *weights, *optimizer_weights], [*all_weights, loss], **compile_kwargs)
        return fn

    def step(self, x_values, y_values) -> np.ndarray:
        """
        Update the model weights in place given a new batch of x_values and y_values.
...
class SGD(Optimizer):
    def __init__(
        ...
        **compile_kwargs,
        ...
        super().__init__(model, loss_fn, ndim_out=ndim_out, **compile_kwargs)
...
class ADAGrad(Optimizer):
    def __init__(
        ...
        **compile_kwargs,
        ...
        super().__init__(
            model, loss_fn, ndim_out=ndim_out, optimizer_weights=g2_weights, **compile_kwargs
        )
...
class Adam(Optimizer):
    def __init__(
        ...
        **compile_kwargs,
        ...
        super().__init__(
            model, loss_fn, ndim_out=ndim_out, optimizer_weights=optimizer_weights, **compile_kwargs
        )
